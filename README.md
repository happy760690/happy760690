...
- [vercel/chatbot](https://github.com/vercel/chatbot) - A full-featured, hackable Next.js AI chatbot built by Vercel (1 day ago)
...
- [langchain-ai/langchain](https://github.com/langchain-ai/langchain) - The agent engineering platform (1 day ago)
- [IncomeStreamSurfer/claude-skills-collection](https://github.com/IncomeStreamSurfer/claude-skills-collection) - Collection of useful skills for Claude Code - AI agents, frontend design, and more (2 days ago)
- [dani-z/frontend-design-skill-benchmark](https://github.com/dani-z/frontend-design-skill-benchmark) - Benchmark: frontend-design Claude skill vs baseline — design quality evals (100% vs 28% pass rate) (2 days ago)
- [steipete/agent-scripts](https://github.com/steipete/agent-scripts) - Scripts for agents, shared between my repositories. (2 days ago)
- [zouyaoji/vue-cesium](https://github.com/zouyaoji/vue-cesium) - 🎉 Vue 3.x components for CesiumJS. (3 days ago)
- [visgl/deck.gl](https://github.com/visgl/deck.gl) - WebGL2 powered visualization framework (3 days ago)
- [mrdoob/three.js](https://github.com/mrdoob/three.js) - JavaScript 3D Library. (3 days ago)
- [openlayers/openlayers](https://github.com/openlayers/openlayers) - OpenLayers (3 days ago)
...
- [stepfun-ai/Step-3.5-Flash](https://github.com/stepfun-ai/Step-3.5-Flash) - Fast, Sharp &amp; Reliable Agentic Intelligence (5 days ago)
...
- [happy760690/chatbot](https://github.com/happy760690/chatbot) -  (1 day ago)
- [happy760690/AI-Chat](https://github.com/happy760690/AI-Chat) - AI Chat (4 days ago)
