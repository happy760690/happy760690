...
- [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) - Build resilient language agents as graphs. (today)
- [langchain-ai/langchain](https://github.com/langchain-ai/langchain) - The agent engineering platform (today)
- [IncomeStreamSurfer/claude-skills-collection](https://github.com/IncomeStreamSurfer/claude-skills-collection) - Collection of useful skills for Claude Code - AI agents, frontend design, and more (1 day ago)
- [dani-z/frontend-design-skill-benchmark](https://github.com/dani-z/frontend-design-skill-benchmark) - Benchmark: frontend-design Claude skill vs baseline — design quality evals (100% vs 28% pass rate) (1 day ago)
...
- [zouyaoji/vue-cesium](https://github.com/zouyaoji/vue-cesium) - 🎉 Vue 3.x components for CesiumJS. (2 days ago)
- [visgl/deck.gl](https://github.com/visgl/deck.gl) - WebGL2 powered visualization framework (2 days ago)
- [mrdoob/three.js](https://github.com/mrdoob/three.js) - JavaScript 3D Library. (2 days ago)
- [openlayers/openlayers](https://github.com/openlayers/openlayers) - OpenLayers (2 days ago)
...
- [stepfun-ai/Step-3.5-Flash](https://github.com/stepfun-ai/Step-3.5-Flash) - Fast, Sharp &amp; Reliable Agentic Intelligence (4 days ago)
