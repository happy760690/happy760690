...
- [lukeed/clsx](https://github.com/lukeed/clsx) - A tiny (239B) utility for constructing `className` strings conditionally. (3 days ago)
- [vercel/chatbot](https://github.com/vercel/chatbot) - A full-featured, hackable Next.js AI chatbot built by Vercel (4 days ago)
- [FoundationAgents/MetaGPT](https://github.com/FoundationAgents/MetaGPT) - 🌟 The Multi-Agent Framework: First AI Software Company, Towards Natural Language Programming (4 days ago)
- [botpress/botpress](https://github.com/botpress/botpress) - The open-source hub to build &amp; deploy GPT/LLM Agents ⚡️ (4 days ago)
...
- [langchain-ai/langchain](https://github.com/langchain-ai/langchain) - The agent engineering platform (4 days ago)
- [IncomeStreamSurfer/claude-skills-collection](https://github.com/IncomeStreamSurfer/claude-skills-collection) - Collection of useful skills for Claude Code - AI agents, frontend design, and more (5 days ago)
- [dani-z/frontend-design-skill-benchmark](https://github.com/dani-z/frontend-design-skill-benchmark) - Benchmark: frontend-design Claude skill vs baseline — design quality evals (100% vs 28% pass rate) (5 days ago)
...
- [zouyaoji/vue-cesium](https://github.com/zouyaoji/vue-cesium) - 🎉 Vue 3.x components for CesiumJS. (6 days ago)
- [visgl/deck.gl](https://github.com/visgl/deck.gl) - WebGL2 powered visualization framework (6 days ago)
- [mrdoob/three.js](https://github.com/mrdoob/three.js) - JavaScript 3D Library. (6 days ago)
- [openlayers/openlayers](https://github.com/openlayers/openlayers) - OpenLayers (6 days ago)
...
- [happy760690/chatbot](https://github.com/happy760690/chatbot) -  (4 days ago)
